...
entity invert_look_ahead_2048 is
  generic (
    G_n       : integer := 2048; -- Input length is n
...
end invert_look_ahead_2048;

architecture behavioral of invert_look_ahead_2048 is
