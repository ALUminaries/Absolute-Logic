...
entity invert_look_ahead_128 is
  generic (
    G_n       : integer := 128; -- Input length is n
...
end invert_look_ahead_128;

architecture behavioral of invert_look_ahead_128 is
